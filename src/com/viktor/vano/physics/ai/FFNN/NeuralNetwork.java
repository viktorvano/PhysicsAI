package com.viktor.vano.physics.ai.FFNN;

import java.util.LinkedList;

import static com.viktor.vano.physics.ai.FFNN.FileManagement.readOrCreateFile;
...
public class NeuralNetwork {
    ...
    public void backProp(LinkedList<Double> targetValues)
    {
        ...
        m_recentAverageError = m_recentAverageSmoothingFactor*m_recentAverageError + (1.0-m_recentAverageSmoothingFactor)*m_error;
