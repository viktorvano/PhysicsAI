...
public class Variables {
    ...
    */
    ...
    public static double velocity = 0.025; // overall net learning rate [0.0..1.0]
    public static double momentum = 0.5; // momentum multiplier of last deltaWeight [0.0..n]
    public static double definedRecentAverageSmoothingFactor = 0.99;


    public static LinkedList<Integer> topology, topology2;
